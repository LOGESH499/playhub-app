...
UPDATE public.venues SET status = status;

-- ─── Venue holidays ─────────────────────────────────────────────────────────

CREATE TABLE public.venue_holidays (
...
CREATE UNIQUE INDEX venue_holidays_venue_date_unique
  ON public.venue_holidays(venue_id, holiday_date);

CREATE INDEX venue_holidays_tenant_id_idx ON public.venue_holidays(tenant_id);
CREATE INDEX venue_holidays_venue_id_idx ON public.venue_holidays(venue_id);
